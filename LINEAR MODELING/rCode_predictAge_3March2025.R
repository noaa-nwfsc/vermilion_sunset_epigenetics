...
meth <- read.csv("methylation_file_all_loci_all_samples.csv",header=TRUE)
depth <- read.csv("coverage_file_all_loci_all_samples.csv",header=TRUE)
...
##############################################
mod <- lm(ageVec~meth_imput[,1] + meth_imput[,2] + meth_imput[,3] + meth_imput[,4] + meth_imput[,5] + meth_imput[,6] + meth_imput[,7])
hist(mod$residuals)
